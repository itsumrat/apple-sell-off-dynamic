			          ...
			          <form @submit.prevent="deliveryAddress">
			            <div class="row">
			              <div class="col-md-6 mb-2">
			              	<div class="form-group">
				                ...
				                <input id="bname" class="form__input" v-model ="customer.customeraddress ? customer.customeraddress.bname : customer.name"/>
			            	</div>
			              </div>
			              <div class="col-md-6 mb-2">
			              	<div class="form-group">
				                <label class="form__label" for="phone">Phone</label>
				                <input id="phone" class="form__input" v-model="customer.customeraddress ? customer.customeraddress.bphone : customer.phone" type="text" placeholder="01728454112"/>
			            	</div>
			              </div>
			            </div>
			            ...
			            <div class="mb-2">
			              <div class="form-group">
						    ...
						    <input id="email" class="form__input" v-model.trim="customer.customeraddress ? customer.customeraddress.bemail : customer.email" placeholder="example@gmail.com" />
						  </div>
			            </div>
			            <div class="row">
			              ...
			              <div class="col-md-4 mb-2">
			                <div class="form-group" :class="{ 'form-group--error': $v.bcity.$error }">
				                ...
				                <select @change="shippingCharge" class="form__input" v-model.trim="$v.bcity.$model" id="bcity">
				                  <option value="">Choose...</option>
				                  <option value="1">Dhaka</option>
			            ...
			            <div class="mb-2">
			            	<div class="form-group">
				              ...
				              <input type="text" class="form__input" v-model="customer.customeraddress ? customer.customeraddress.baddress : customer.address" id="baddress" placeholder="House#45, Nikunja-2, Khilkhet, Dhaka-1229">
			              	</div>
			            </div>
			            <hr class="mb-1">
