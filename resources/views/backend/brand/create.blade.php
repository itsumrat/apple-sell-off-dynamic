...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('brands.store') }}" enctype="multipart/form-data" file="true" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="brand_description" name="brand_description" type="text">
                                </input>
                            </div>
                            <div class="form-group">
