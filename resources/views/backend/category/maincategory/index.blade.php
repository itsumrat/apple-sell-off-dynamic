            ...
            <table cellspacing="0" class="table table-bordered custom-btn" id="dataTable" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $maincategory->mc_name }}
                        </td>
                        <td>
                            @can('category-edit')
                            <a class="admin-actionbtn" href="{{ route('maincategory.edit',$maincategory->id) }}">
                                <i class="far fa-edit">
                                </i>
                            </a>
                            @endcan
                            @can('category-delete')
                            {!! Form::open(['method' => 'DELETE','route' => ['maincategory.destroy', $maincategory->id],'style'=>'display:inline', 'class'=>'delete_form']) !!}
